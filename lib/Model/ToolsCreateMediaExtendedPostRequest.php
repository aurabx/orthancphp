...
class ToolsCreateMediaExtendedPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets transcode
     *
     * @param string|null $transcode If present, the DICOM files in the archive will be transcoded to the provided transfer syntax: https://orthanc.uclouvain.be/book/faq/transcoding.html
     *
     * @return self
     */
