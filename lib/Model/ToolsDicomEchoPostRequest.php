...
class ToolsDicomEchoPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('checkFind', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['checkFind'];
    }

    /**
     * Sets checkFind
     *
     * @param bool|null $checkFind Issue a dummy C-FIND command after the C-GET SCU, in order to check whether the remote modality knows about Orthanc. This field defaults to the value of the `DicomEchoChecksFind` configuration option. New in Orthanc 1.8.1.
     *
     * @return self
     */
    public function setCheckFind($checkFind)
    {
        if (is_null($checkFind)) {
            throw new \InvalidArgumentException('non-nullable checkFind cannot be null');
        }
        $this->container['checkFind'] = $checkFind;
