...
class SeriesIdStatisticsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets countInstances
     *
     * @param float|null $countInstances Number of child instances within this series
     *
     * @return self
     */
     ...
     * Sets dicomDiskSize
     *
     * @param string|null $dicomDiskSize Size on the disk of the DICOM instances associated with the series, expressed in bytes
     *
     * @return self
     */
     ...
     *
     * @param float|null $dicomDiskSizeMB Size on the disk of the DICOM instances associated with the series, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     *
     * @param string|null $dicomUncompressedSize Size on the disk of the uncompressed DICOM instances associated with the series, expressed in bytes
     *
     * @return self
     */
     ...
     *
     * @param float|null $dicomUncompressedSizeMB Size on the disk of the uncompressed DICOM instances associated with the series, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     * Sets diskSize
     *
     * @param string|null $diskSize Size of the series on the disk in bytes, expressed as a string for 64bit compatibility with JSON
     *
     * @return self
     */
     ...
     * Sets diskSizeMB
     *
     * @param float|null $diskSizeMB Size of the series on the disk, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     *
     * @param string|null $uncompressedSize Size of the series after decompression in bytes, expressed as a string for 64bit compatibility with JSON
     *
     * @return self
     */
     ...
     *
     * @param float|null $uncompressedSizeMB Size of the series after decompression, expressed in megabytes (MB). This is different from `DiskSizeMB` iff `StorageCompression` is `true`.
     *
     * @return self
     */
