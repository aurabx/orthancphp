...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://orthanc.uclouvain.be/demo';
    ...
    {
        $report  = 'PHP SDK (Aurabx\OrthancPHP) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.12.4' . PHP_EOL;
